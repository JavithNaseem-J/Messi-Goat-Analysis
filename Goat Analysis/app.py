...
st.sidebar.image("messi.jpg", use_column_width=True)
...
if selections == "Introduction":
    st.title("⚽ ")
    st.subheader("Lionel  Messi - All Club Goals Statistics")
    ...
    **Cristiano Ronaldo dos Santos Aveiro** is a Portuguese professional footballer who plays as a forward for Al-Nassr and captains the Portugal national team.
    ...
    - **Born**: July 26, 1987 (age 37 years), Rosario, Argentina
    - **Height**: 1.87 m
    - **Spouse**: Georgina Rodríguez (2017–)
